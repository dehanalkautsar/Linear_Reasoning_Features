...
LOG_FILE="${LOGS_DIR}/intervention_scale_0.05_Understand${LANG_SUFFIX}.log"
...
python "${SCRIPT_DIR}/features_intervention.py" \
  ...
  --metrics_out "${METRICS_DIR}/intervention_scale_0.05_Understand_metrics${LANG_SUFFIX}.json" \
  2>&1 | tee "${LOG_FILE}"
